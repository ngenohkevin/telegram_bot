...
func Handler(res http.ResponseWriter, req *http.Request) {
	...
	if !strings.Contains(strings.ToLower(body.Message.Text), "kev") {
		return
	}
...
func sayPolo(chatID int64) error {
	...
	res, err := http.Post("https://api.telegram.org/bot<>/sendMessage", "application/json", bytes.NewBuffer(reqBytes))
	if err != nil {
		return err
	}
